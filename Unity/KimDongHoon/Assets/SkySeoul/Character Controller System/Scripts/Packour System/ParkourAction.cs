...
[CreateAssetMenu(fileName = "PackourAction",menuName = "Parkour System/New parkour action")]
public class ParkourAction : ScriptableObject
{
    ...
    public virtual bool CheckIfPossible(ObstalceHitData hitData, Transform player)
    {
        // Tag Check
